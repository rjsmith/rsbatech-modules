...
OrestesSettings pluginSettings;


void OrestesSettings::saveToJson() {
	...
	std::string settingsFilename = rack::asset::user("Orestes.json");
...
void OrestesSettings::readFromJson() {
	std::string settingsFilename = rack::asset::user("Orestes.json");
